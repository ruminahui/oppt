...
enum INTENTION_VEC_INFO{INTENTION_REL_HORIZONTAL, INTENTION_REL_LONGIT, INTENTION_VAL};
...
class NCAPUserData: public RobotStateUserData {
public:
    NCAPUserData():
        RobotStateUserData() {
    }

    virtual ~NCAPUserData() = default;
